    ...
    async onOpen() {
        try {
            ...
            if (modalEl) {
                ...
                // Force responsive sizing with highest priority
                // First set base styles
                modalEl.style.setProperty('background', 'var(--background-primary)', 'important');
                modalEl.style.setProperty('border', '1px solid var(--background-modifier-border)', 'important');
                modalEl.style.setProperty('border-radius', '12px', 'important');
                modalEl.style.setProperty('box-shadow', '0 8px 24px rgba(0, 0, 0, 0.4)', 'important');

                console.log('🔧 Modal window width:', window.innerWidth);

                if (window.innerWidth <= 375) {
                    console.log('📱 Applying extra small mobile styles');
                    // Extra small screens - force override
                    modalEl.style.setProperty('width', '92vw', 'important');
                    modalEl.style.setProperty('min-width', '280px', 'important');
                    modalEl.style.setProperty('max-width', '340px', 'important');
                    modalEl.style.setProperty('max-height', '75vh', 'important');
                    modalEl.style.setProperty('padding', '0.4rem', 'important');
                    modalEl.style.setProperty('overflow-y', 'auto', 'important');
                    modalEl.style.setProperty('box-sizing', 'border-box', 'important');
                } else if (window.innerWidth <= 480) {
                    console.log('📱 Applying small mobile styles');
                    // Small mobile screens - force override
                    modalEl.style.setProperty('width', '95vw', 'important');
                    modalEl.style.setProperty('min-width', '280px', 'important');
                    modalEl.style.setProperty('max-width', '370px', 'important');
                    modalEl.style.setProperty('max-height', '80vh', 'important');
                    modalEl.style.setProperty('padding', '0.5rem', 'important');
                    modalEl.style.setProperty('overflow-y', 'auto', 'important');
                    modalEl.style.setProperty('box-sizing', 'border-box', 'important');
                } else {
                    console.log('🖥️ Applying desktop styles');
                    // Desktop and larger screens
                    modalEl.style.setProperty('min-width', '320px', 'important');
                    modalEl.style.setProperty('max-width', '600px', 'important');
                ...
                modalEl.style.setProperty('z-index', '10001', 'important');
