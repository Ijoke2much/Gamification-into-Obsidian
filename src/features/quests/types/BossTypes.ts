...
export interface PlayerStats {
    strength: number;      // Physical power for attacks
    endurance: number;     // Health and defense 
    focus: number;         // Mental attacks and accuracy
    intelligence: number;  // Special attacks and strategy
    creativity: number;    // Unique moves and combinations
    motivation: number;    // Battle persistence and recovery
    patience: number;      // Defensive abilities and timing
    agility?: number;      // Speed and evasion (optional)
    charisma?: number;     // Social-based abilities (optional)
}
