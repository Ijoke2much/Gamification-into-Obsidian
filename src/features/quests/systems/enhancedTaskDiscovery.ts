...
export class EnhancedTaskDiscovery {
     ...
     */
    private extractPriority(line: string): 'lowest' | 'low' | 'medium' | 'high' | 'highest' {
        if (line.includes('#priority-highest') || line.includes('#critical')) {
            return 'highest';
        }
        if (line.includes('#priority-high') || line.includes('#urgent')) {
            return 'high';
        }
        if (line.includes('#priority-medium')) {
            return 'medium';
        }
        if (line.includes('#priority-low')) {
            return 'low';
        }
        if (line.includes('#priority-lowest') || line.includes('#optional')) {
            return 'lowest';
        }
        return 'medium';
    }
