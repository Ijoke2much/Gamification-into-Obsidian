...
export const CreateTaskModal: React.FC<CreateTaskModalProps> = ({
    ...
    const currencyName: string = ((window as Window & { app?: { plugins?: { plugins?: Record<string, { settings?: { currencyName?: string } }> } } })?.app?.plugins?.plugins?.["gamified-obsidian-plugin"]
