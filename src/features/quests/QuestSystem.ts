...
import { QuestSharingSystem, SharedQuest, QuestPermissions } from './sharing/QuestSharingSystem';
...
export interface QuestSystemPermissions {
    read: boolean;
    write: boolean;
    share: boolean;
    delete?: boolean;
...
export class QuestSystem {
     ...
     */
    async shareQuest(questId: string, targetVaults: string[], permissions?: Partial<QuestPermissions>): Promise<SharedQuest> {
        if (!this.config.enableSharing) {
     ...
     */
    getAnalyticsInsights(): Record<string, unknown> | null {
