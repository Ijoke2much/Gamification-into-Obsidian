...
export interface PlayerData {
	...
	xp: number;
	xpRequired: number;
	total_exp: number; // Total XP earned across all time (for analytics/achievements)
	...
	// Dynamic debt tracking (keys like "debtUsedXP_2025-09-04")
	[key: string]: any; // Allow dynamic fields for date-specific debt tracking
