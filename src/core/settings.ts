...
export const SETTINGS_CATEGORIES: SettingsCategory[] = [
  ...
  },
  {
    ...
    color: '#607D8B',
    settings: ['shopkeeperImagePath', 'questGiverImagePath', 'avatarFolder', 'inventoryFilePath', 'masterClassFolder', 'classFolder', 'skillFolder', 'statFolder']
  },
  {
    id: 'advanced',
    name: 'Advanced',
...
export const SETTINGS_PRESETS: SettingsPreset[] = [
  {
    ...
    description: "Gentle settings for new players with lower penalties and higher rewards",
    icon: "🌟",
    settings: {
      xpPerTask: 15,
      coinPerTask: 8,
  ...
  {
    name: "Hardcore Mode",
    description: "Challenging settings with higher penalties and lower rewards",
    icon: "💀",
    settings: {
      xpPerTask: 5,
      coinPerTask: 2,
  ...
  },
  {
    ...
    description: "Emphasizes energy management with higher energy costs and recovery",
    icon: "⚡",
    settings: {
  ...
  {
    name: "Quest Master",
    description: "Optimized for quest-heavy gameplay with enhanced quest features",
    icon: "📋",
    settings: {
  ...
  },
  {
    ...
    description: "Enhanced shop features with frequent rotations and events",
    icon: "🛒",
    settings: {
